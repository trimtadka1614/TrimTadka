                              ...
                              <div className="w-full">
                                ...
                                <div className="mt-4 text-xs text-gray-600 bg-gray-100 p-3 rounded-md border border-gray-200 shadow-inner">
                                  ...
                                  <ul className="list-disc list-inside space-y-1">
                                    <li>
                                      <span className="font-medium">IMAGES:</span> PORTRAIT ORIENTATION • MAX 2MB • JPG, PNG, GIF, WEBP.
                                    </li>
                                    <li>
                                      <span className="font-medium">VIDEOS:</span> PORTRAIT ORIENTATION • MAX 10MB • MP4, WEBM, MOV, AVI, QUICKTIME.
                                    </li>
                                  </ul>
                                </div>
                              </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-5 mb-8 p-6 border-2 border-purple-200 rounded-lg bg-purple-50 shadow-inner">
                              ...
                              <div className="flex-grow">
                                ...
                                <div className="mt-4 text-xs text-gray-600 bg-gray-100 p-3 rounded-md border border-gray-200 shadow-inner">
                                  ...
                                  <ul className="list-disc list-inside space-y-1">
                                    <li>
                                      <span className="font-medium">IMAGES:</span> LANDSCAPE ORIENTATION (WIDTH &gt; HEIGHT) • MAX 2MB • JPG, PNG, GIF, WEBP.
                                    </li>
                                  </ul>
                                </div>
                              </div>
